    ...
    return (
        <div className='max-w-7xl mx-auto'>
            ...
            <div className=' my-2 mx-4'>
                ...
                <div>
                    {doctor?.about && doctor?.about.items.map((item, index) => (
                ...
                <div className='flex flex-wrap gap-2'>
                    {doctor?.specialInterests && doctor?.specialInterests.map((specialInterest, index) => (
                ...
                <div className='grid grid-cols-2'>
                    {doctor?.skilledAt && doctor?.skilledAt.map((item, index) => (
                ...
                <Tabs defaultValue="education" className="w-[400px] my-2 pb-10">
                    ...
                    <TabsContent value="education">
                        <div>
                            {doctor?.education && doctor?.education.map((item, index) => (
                    ...
                    <TabsContent value="experience">
                        <div>
                            {doctor?.experience && doctor?.experience.map((item, index) => (
                                <p key={index} className="text-gray-700 font-semibold flex gap-x-1 text-sm items-start max-w-4xl my-2"><span className='text-green-500'> &#x2714;</span>{item}</p>
                            ))}
                        </div>
                    </TabsContent>
                    <TabsContent value="awards">
                        <div>
                            {doctor?.awards && doctor?.awards.map((item, index) => (
                                <p key={index} className="text-gray-700 font-semibold flex gap-x-1 text-sm items-start max-w-4xl my-2"><span className='text-green-500'> &#x2714;</span>{item}</p>
                            ))}
                        </div>
                    </TabsContent>
