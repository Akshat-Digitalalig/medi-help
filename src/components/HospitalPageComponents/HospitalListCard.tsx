      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-2/3 p-6">
          ...
          <div className="flex space-x-4 mt-6">
            ...
            })} className="bg-green-500 text-white px-4 py-3 rounded-lg hover:bg-green-600 flex gap-1 leading-none flex-col md:flex-row items-center"> <Phone /> WhatsApp Us</button>
          </div>
        </div>
      </div>
    </div>
