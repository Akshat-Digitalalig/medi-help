  ...
  return (
    <div className="bg-[#e0f5ff] py-6 sm:py-8 mb-8 lg:py-12">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-12">
        ...
        <div className="grid gap-4 md:gap-12 grid-cols-2 md:grid-cols-3 xl:grid-cols-3 x">
...
function FeatureItem({ title, description, ImgPath }: FeatureItemProps) {
  return (
    <div className="flex flex-col justify-between bg-white shadow-lg rounded-3xl p-4 items-center">
