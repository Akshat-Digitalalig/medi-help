        ...
        <div className='flex flex-col justify-center items-center  '>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 mx-4 gap-6 my-4 '>
                {medicalServices.map((ms, index) => (
                    <Link href={`/homeTreatments/${ms.category}`} key={index} className=' flex py-2 flex-col  items-center md:py-3 px-2 md:px-3 gap-x-2 rounded-lg w-full shadow bg-light'>
