    ...
    return (
        <div className='bg-[#e1f5ff] w-full '>
            <header className={` ${manrope.className} max-w-screen-2xl mx-auto flex items-center justify-between`}>
                ...
                <LanguageSwitcher />
                <button className="hidden md:flex items-center mx-2 leading-none text-xs font-semibold bg-red-500 gap-1 px-2 md:px-4 py-2 cursor-pointer text-white  rounded-md hover:bg-red-700 duration-300">
                    Free Consults
