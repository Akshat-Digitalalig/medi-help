    ...
    <>
      ...
      <div className="bg-[#e1f5ff] w-full">
        ...
        >
          <Link
            href={"/"}
            className="cursor-pointer relative w-[48%] h-[65px] sm:h-[80px] sm:w-[35%] md:w-[30%] md:h-[60px] lg:h-[65px] lg:w-[22%] my-1 mx-1 md:mx-2 text-lg text-white font-semibold p-2 md:p-0"
            aria-label="logo"
          >
            <Image
              src="/medilogo.webp"
