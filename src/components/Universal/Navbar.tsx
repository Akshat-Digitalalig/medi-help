'use client';
import { CircleX, ClipboardPlus, Contact, GraduationCap, HandCoins, HeartHandshake, HeartPulse, HomeIcon, Hospital, Menu } from 'lucide-react'
        ...
        <>
            ...
            <div className='bg-[#e1f5ff] w-full'>
                <header className={` ${manrope.className} max-w-screen-2xl mx-auto flex items-center justify-between`}>
                    ...
                    <Link href={'/consult-online'} className="hidden md:flex  items-center justify-center  leading-none text-xs font-semibold bg-myblue gap-1 px-2 md:px-4 py-2 cursor-pointer text-white  rounded-md hover:bg-white hover:text-myblue hover:border-myblue border-2 duration-300">
                        Health Advisor
                    ...
                    <button onClick={toggleSidebar} className='text-indigo-950 block md:hidden border-2 border-myblue p-1 rounded-md mx-2'>
                        <Menu size={24} />
                    </button>
